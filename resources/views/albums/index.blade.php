                        ...
                        <div class="row">
                            ...
                            <div class="col-4">
                                <div class="card border-dark mb-3">
                                    <img src="{{asset('img/portadaEvento.jpeg')}}" alt="" class="img-fluid">
                                    <div class="card-footer">
                                        ...
                                        <div class='card' style='width: 18rem'>
                                            ...
                                            <div class='card-body'>
                                                ...
                                                <form action="{{route('verEventoFoto', ["evento_id"=>$eventos->id,"org_id"=>$eventos->user_id,"fotografo_id"=>auth()->user()->id])}}" class="d-inline" method="POST">
                                                    @method('POST')
                                                    @csrf
                                                    <br>
